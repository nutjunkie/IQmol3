...
namespace IQmol {
   ...
   class Viewer : public QGLViewer, protected QOpenGLFunctions {
      ...
      public Q_SLOTS:
         ...
         void qglColor(QColor const& color);
         void qglClearColor(QColor const& clearColor);
         //void renderText(double const x, double const y, double const z, 
         //   const QString& str, const QFont & font = QFont());
