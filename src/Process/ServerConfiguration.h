...
#include <QVariant>
#include "Data/YamlNode.h"
#include "Network/SshConnection.h"
   ...
   class ServerConfiguration {
      ...
      public:
         enum FieldT { ServerName = 0, Connection, QueueSystem, HostAddress, Port,
                       ...
                       AuthenticationPort, 
                       AwsRegion, CognitoUserPool, CognitoAppClient, ApiGateway,
                       MaxFieldT };
                       
         // The order of these is used to set the queueSystem combo box
         // in the ServerConfigutationDialog.C
         enum QueueSystemT { Basic, PBS, SGE, SLURM, Web, AWS };
