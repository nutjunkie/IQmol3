...
namespace Layer {
   ...
   /// Abstract base class for a group of GLObjects.  
   ///
   /// This level accounts for shader context switching.

   class GLGroup : public Base {
      ...
      public: 
         ...
         explicit GLGroup(QString const& text = QString()) : Base(text), m_alpha(1.0),
            m_clip(false)
         { 
